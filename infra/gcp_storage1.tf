...
resource "google_compute_autoscaler" "gcp_storage1_autoscaler" {
  ...
  zone   = "us-central1-a"
  target = google_compute_instance_group_manager.gcp_storage1_group.self_link
...
resource "google_compute_instance_group_manager" "gcp_storage1_group_manager" {
  name        = "gcp-storage-1-group-manager"
  zone        = "us-central1-a"
